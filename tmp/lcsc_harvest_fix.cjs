/* Resumable LCSC harvester: walks tmp/lcsc_queue_fix.json, saves ranked rows to
...
const queue = JSON.parse(fs.readFileSync(path.join(ROOT, 'tmp/lcsc_queue_fix.json'), 'utf-8'));
