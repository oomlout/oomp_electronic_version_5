...
Connector Header 2.54 mm pitch through hole right angle short pin 31 pin is an OOMP electronic connector definition. It uses the header package or form factor. Its nominal drawing size is 10.36 &#x00D7; 78.74 mm. The definition includes 31 documented pins.

![Connector Header 2.54 mm pitch through hole right angle short pin 31 pin pinout](data/working_svg_top.svg)
