# KiCad assets: electronic_led_strip_5_volt_8_mm_width_pink_1000_mm_length_320_leds_per_meter
...
Silkscreen code: `YBCF`. Source provenance: [manifest](manifest.yaml).
