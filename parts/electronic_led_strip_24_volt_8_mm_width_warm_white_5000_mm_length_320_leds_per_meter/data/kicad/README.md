# KiCad assets: electronic_led_strip_24_volt_8_mm_width_warm_white_5000_mm_length_320_leds_per_meter
...
Silkscreen code: `UGDE`. Source provenance: [manifest](manifest.yaml).
