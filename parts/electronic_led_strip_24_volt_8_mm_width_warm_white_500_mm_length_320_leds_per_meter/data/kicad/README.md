# KiCad assets: electronic_led_strip_24_volt_8_mm_width_warm_white_500_mm_length_320_leds_per_meter
...
Silkscreen code: `9T9VW`. Source provenance: [manifest](manifest.yaml).
