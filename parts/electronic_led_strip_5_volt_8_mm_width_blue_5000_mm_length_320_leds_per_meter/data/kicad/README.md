# KiCad assets: electronic_led_strip_5_volt_8_mm_width_blue_5000_mm_length_320_leds_per_meter
...
Silkscreen code: `ZDBG`. Source provenance: [manifest](manifest.yaml).
