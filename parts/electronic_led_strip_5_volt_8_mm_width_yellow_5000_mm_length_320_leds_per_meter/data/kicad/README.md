# KiCad assets: electronic_led_strip_5_volt_8_mm_width_yellow_5000_mm_length_320_leds_per_meter
...
Silkscreen code: `L9OR`. Source provenance: [manifest](manifest.yaml).
