# KiCad assets: electronic_led_strip_5_volt_8_mm_width_pink_2000_mm_length_320_leds_per_meter
...
Silkscreen code: `74S0D`. Source provenance: [manifest](manifest.yaml).
