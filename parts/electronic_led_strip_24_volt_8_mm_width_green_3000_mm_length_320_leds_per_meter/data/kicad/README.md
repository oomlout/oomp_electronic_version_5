# KiCad assets: electronic_led_strip_24_volt_8_mm_width_green_3000_mm_length_320_leds_per_meter
...
Silkscreen code: `B9VX`. Source provenance: [manifest](manifest.yaml).
