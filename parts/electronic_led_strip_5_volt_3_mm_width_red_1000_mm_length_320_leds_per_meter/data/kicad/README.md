# KiCad assets: electronic_led_strip_5_volt_3_mm_width_red_1000_mm_length_320_leds_per_meter
...
Silkscreen code: `EPNT`. Source provenance: [manifest](manifest.yaml).
