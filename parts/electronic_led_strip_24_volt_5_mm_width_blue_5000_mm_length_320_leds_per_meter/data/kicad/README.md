# KiCad assets: electronic_led_strip_24_volt_5_mm_width_blue_5000_mm_length_320_leds_per_meter
...
Silkscreen code: `CG5N`. Source provenance: [manifest](manifest.yaml).
