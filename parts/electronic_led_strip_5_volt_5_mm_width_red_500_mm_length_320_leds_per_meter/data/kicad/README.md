# KiCad assets: electronic_led_strip_5_volt_5_mm_width_red_500_mm_length_320_leds_per_meter
...
Silkscreen code: `9DEFN`. Source provenance: [manifest](manifest.yaml).
