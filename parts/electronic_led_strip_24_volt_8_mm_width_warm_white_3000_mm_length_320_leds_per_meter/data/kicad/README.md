# KiCad assets: electronic_led_strip_24_volt_8_mm_width_warm_white_3000_mm_length_320_leds_per_meter
...
Silkscreen code: `OBTC`. Source provenance: [manifest](manifest.yaml).
