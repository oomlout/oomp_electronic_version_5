# KiCad assets: electronic_led_strip_5_volt_8_mm_width_blue_1000_mm_length_320_leds_per_meter
...
Silkscreen code: `45OVG`. Source provenance: [manifest](manifest.yaml).
