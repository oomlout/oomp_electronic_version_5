# KiCad assets: electronic_led_strip_5_volt_8_mm_width_green_5000_mm_length_320_leds_per_meter
...
Silkscreen code: `TQLE`. Source provenance: [manifest](manifest.yaml).
